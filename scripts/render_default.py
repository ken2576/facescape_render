...
if __name__ == '__main__':
    ...
    ############## Get Poses ##############
    # Source + Target Self Rotation + Target
    # num_sets*num_views + num_sets + num_tgts

    # Get source view poses
    for i in range(args.num_sets):
        pose, radius = gen_multiview_poses(args.rmin,
                                           args.rmax,
                                           args.theta_max,
                                           args.phi_max,
                                           args.num_views)
    ...
    # Get target view poses (self rotation)
    pose, radius = gen_random_poses(args.rmin,
                                    args.rmax,
                                    args.theta_max,
                                    args.phi_max,
                                    args.num_sets)
    ...
    # Get target view poses (random lighting)
    pose, radius = gen_random_poses(args.rmin,
                                    args.rmax,
                                    args.theta_max,
                                    args.phi_max,
    ...
    for i in range(args.num_sets):
        ...
        ori_env_path = rendered_env[i*args.num_views]
